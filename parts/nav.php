<nav class="navbar fundoGradiente m-0 p-0 navbar-expand-md">
    <div class="container-fluid m-0 p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav col-md-12 px-2">


                <div class="col-md-6 col-lg-12 d-md-flex justify-content-end">
                    <li class="nav-item d-md-inline-flex justify-content-end align-items-center hover rounded-5 px-2">
